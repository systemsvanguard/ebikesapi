...
class Database {
  ...
  private $password = 'th15Is@F@keP@55Word4D1splay0nly!!';
  /* 
  This visible password above is fake, and 
  is NOT excluded from the git repo via .gitignore (the Best Practice).  
